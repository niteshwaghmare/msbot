...
from bot.cards.country_card import ACTION_SELECT_COUNTRY
from bot.cards.operation_card import ACTION_SELECT_OPERATION
from bot.cards.upload_card import ACTION_SUBMIT_DOCUMENTS
