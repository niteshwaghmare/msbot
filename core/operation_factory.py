"""Factory for workflow operation services."""
...
class OperationFactory:
    """Resolve configured operation names to BaseOperation services."""
    ...
    def get(cls, operation_name: str) -> BaseOperation:
        """Return the service configured for an operation name."""
        try:
            return cls._operations[operation_name]
        except KeyError as error:
            raise ValueError(f"Unknown workflow operation: {operation_name}") from error
